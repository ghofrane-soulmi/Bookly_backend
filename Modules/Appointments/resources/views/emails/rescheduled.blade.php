...
<body style="font-family: Arial, sans-serif; color: #22303E; margin: 0; padding: 24px; background: #f5f5f9;">
    <div style="max-width: 480px; margin: 0 auto; background: #fff; border-radius: 8px; padding: 32px;">
        ...
        <table style="width: 100%; border-collapse: collapse; margin: 16px 0;">
            ...
            <tr>
                <td style="padding: 8px 0; color: #6b7280;">New time</td>
        ...
        @if ($appointment->notes)
            <p style="color: #6b7280;">Notes: {{ $appointment->notes }}</p>
        @endif
        <p style="color: #6b7280; font-size: 13px; margin-top: 32px;">
            If this new time doesn't work for you, please contact {{ $appointment->business->name }} directly.
        </p>
    </div>
</body>
</html>
